...
export const profileStyles = {
  ...
  userName: "text-[1 rem] mb-1 break-all sm:break-normal",
  ...
  formActions: "flex flex-col md:flex-row gap-4 mt-2",
  ...
  infoSection: "flex flex-col gap-5",
  ...
  editButtonWrapper: "mt-8 pt-2 border-t border-border",
...
export const landingPageStyles = {
  ...
  // Hero section
  heroSection:
    "fade-in items-center justify-center  hero-section pt-25 pb-10 xl:px-40 md:px-20 flex items-center gap-16 overflow-hidden md:flex-col lg:flex-col xl:flex-row max-lg:flex-col max-lg:text-center max-lg:pt-28 max-lg:pb-8 max-lg:px-4 max-lg:gap-8",
  heroContent:
    "hero-content flex-1 max-lg:flex max-lg:flex-col max-lg:items-center",
  badge: "badge bg-primary-light text-primary-dark mb-4 inline-block",
  heroTitle:
  ...
  labelSmall:
    "text-[0.7rem] font-extrabold text-text-muted uppercase tracking-[0.05em] mb-1 placeholder:text-gray-500",
  inputTransparent:
  ...
  heroImage: "w-full h-[500px] object-cover",
  verifiedBadge:
...
export const loginStyles = {
  ...
  card: "glass fade-in w-full max-w-[450px] p-10 sm:p-6 rounded-3xl sm:rounded-2xl shadow-lg",
  title: "text-[2rem] sm:text-2xl font-bold text-center mb-2 text-primary",
  subtitle: "text-center text-text-muted mb-8",
...
export const registerStyles = {
  ...
  // Form card
  formCard: "w-full max-w-[500px] p-10 sm:p-6 rounded-3xl bg-white shadow-lg",
...
backdrop: (isOpen) => `
  fixed inset-0 w-full h-full bg-black/30 backdrop-blur-sm z-[950] 
  transition-all duration-300 
  md:hidden
  ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}
`
    ,
sidebar: (isOpen) => `fixed left-0 top-0 w-[260px] h-screen bg-white border-r border-[#f1f5f9] py-8 px-5 flex flex-col z-[1000] transition-transform duration-300 ${
...
export const logoStyles = {
  link: "font-bold text flex items-center gap-3 no-underline whitespace-nowrap",
  iconWrapper: "bg-primary text-white p-2 rounded-[10px] flex items-center justify-center shadow-[0_4px_12px_rgba(13,110,89,0.2)]",
  text: "font-comfortaa font-extrabold tracking-[-0.02em] text-black ",
};
...
export const propertyCardStyles = {
  ...
  // Image section
  imageSection: "relative h-[220px] overflow-visible shrink-0",
  ...
  wishlistButton: (isWishlisted) => `flex items-center justify-center w-8 h-8 rounded-full border-none cursor-pointer shadow-[0_2px_8px_rgba(0,0,0,0.1)] transition-all duration-200 z-[10] hover:text-red-500 hover:scale-110 hover:bg-white ${isWishlisted ? 'text-red-500 bg-white' : 'text-[#64748b] bg-white/90'}`,
